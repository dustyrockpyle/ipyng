describe("$ipyMessageHandler", function() {
  ...
  beforeEach(inject(function (_$ipyMessage_, _$rootScope_, _$ipyWebsocketHandler_, _$ipyMessageHandler_) {
    $ipyMessage = _$ipyMessage_;
    $rootScope = _$rootScope_;
    $ipyWebsocketHandler = _$ipyWebsocketHandler_;
    $ipyMessageHandler = _$ipyMessageHandler_;
